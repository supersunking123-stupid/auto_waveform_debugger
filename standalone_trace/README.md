...
build/rtl_trace whereis-instance --db rtl_trace.db --instance top.u0 [--format text|json] [--show-params]
...
- `whereis-instance --show-params`: also emits elaborated parameter / localparam values and type parameters for that specific instance when the DB was generated as `v4`.
